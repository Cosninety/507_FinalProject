...
#     fieldnames = ["Catalog Number","Nationality", "Gender", "Art_type", "Name", "Catalog Number2", "Description", "Image Source"]
#     writer = csv.DictWriter(csvfile, fieldnames = fieldnames)
#
#     writer.writeheader()
#     for i in scraped_list_of_lists:
#         try:
#             writer.writerow({'Catalog Number':i[0], "Nationality" :i[1] ,"Gender" :i[2],"Art_type" :i[-5], "Name" :i[-4],"Catalog Number2" :i[-3], "Description": i[-2] , "Image Source": i[-1] })
#         except:
#             continue
